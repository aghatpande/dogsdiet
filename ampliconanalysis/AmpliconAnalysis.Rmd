...
### reading in supplementary info from paper to identify diet responsive and unresponsive dogs to analyze them as categories

```{r reading in supplementary data from study}
