...
## Creating a metadata files with information about the samples after categorizing them
...
alpha / beta diversity with only 4 categories 

    qiime diversity core-metrics-phylogenetic \
     --i-phylogeny EnticeAmplicons-rooted-tree.qza \
     --i-table amplicons-table-dada2.qza \
     --p-sampling-depth 13286 \
     --m-metadata-file ENTiCEampliconMetadata.tsv \
     --output-dir Enticeamplicons-core-metrics-results \
     ;
   ...
   * The starting pt for the sampling depth parameter was 10600 from Beiting paper, we inc. sampling depth until we had 25% of features (~ 2.5 million) in 70% (187) samples.
   ...
   Qiime2 executed the command with mesg:
   
Saved FeatureTable[Frequency] to: Enticeamplicons-core-metrics-results/rarefied_table.qza
Saved SampleData[AlphaDiversity] % Properties('phylogenetic') to: Enticeamplicons-core-metrics-results/faith_pd_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-core-metrics-results/observed_otus_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-core-metrics-results/shannon_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-core-metrics-results/evenness_vector.qza
Saved DistanceMatrix % Properties('phylogenetic') to: Enticeamplicons-core-metrics-results/unweighted_unifrac_distance_matrix.qza
Saved DistanceMatrix % Properties('phylogenetic') to: Enticeamplicons-core-metrics-results/weighted_unifrac_distance_matrix.qza
Saved DistanceMatrix to: Enticeamplicons-core-metrics-results/jaccard_distance_matrix.qza
Saved DistanceMatrix to: Enticeamplicons-core-metrics-results/bray_curtis_distance_matrix.qza
Saved PCoAResults to: Enticeamplicons-core-metrics-results/unweighted_unifrac_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-core-metrics-results/weighted_unifrac_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-core-metrics-results/jaccard_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-core-metrics-results/bray_curtis_pcoa_results.qza
Saved Visualization to: Enticeamplicons-core-metrics-results/unweighted_unifrac_emperor.qzv
Saved Visualization to: Enticeamplicons-core-metrics-results/weighted_unifrac_emperor.qzv
Saved Visualization to: Enticeamplicons-core-metrics-results/jaccard_emperor.qzv
Saved Visualization to: Enticeamplicons-core-metrics-results/bray_curtis_emperor.qzv
   

Repeating the alpha / beta diversity 'core metrics' analysis with the additional sub-categories generated:

    qiime diversity core-metrics-phylogenetic \
        --i-phylogeny EnticeAmplicons-rooted-tree.qza \
        --i-table amplicons-table-dada2.qza \
        --p-sampling-depth 13286 \
        --m-metadata-file ENTiCEampliconsub1Metadata.tsv \
        --output-dir Enticeamplicons-sub1-core-metrics-results \
        ;
        
Qiime executed with mesg:
Saved FeatureTable[Frequency] to: Enticeamplicons-sub1-core-metrics-results/rarefied_table.qza
Saved SampleData[AlphaDiversity] % Properties('phylogenetic') to: Enticeamplicons-sub1-core-metrics-results/faith_pd_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-sub1-core-metrics-results/observed_otus_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-sub1-core-metrics-results/shannon_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-sub1-core-metrics-results/evenness_vector.qza
Saved DistanceMatrix % Properties('phylogenetic') to: Enticeamplicons-sub1-core-metrics-results/unweighted_unifrac_distance_matrix.qza
Saved DistanceMatrix % Properties('phylogenetic') to: Enticeamplicons-sub1-core-metrics-results/weighted_unifrac_distance_matrix.qza
Saved DistanceMatrix to: Enticeamplicons-sub1-core-metrics-results/jaccard_distance_matrix.qza
Saved DistanceMatrix to: Enticeamplicons-sub1-core-metrics-results/bray_curtis_distance_matrix.qza
Saved PCoAResults to: Enticeamplicons-sub1-core-metrics-results/unweighted_unifrac_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-sub1-core-metrics-results/weighted_unifrac_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-sub1-core-metrics-results/jaccard_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-sub1-core-metrics-results/bray_curtis_pcoa_results.qza
Saved Visualization to: Enticeamplicons-sub1-core-metrics-results/unweighted_unifrac_emperor.qzv
Saved Visualization to: Enticeamplicons-sub1-core-metrics-results/weighted_unifrac_emperor.qzv
Saved Visualization to: Enticeamplicons-sub1-core-metrics-results/jaccard_emperor.qzv
Saved Visualization to: Enticeamplicons-sub1-core-metrics-results/bray_curtis_emperor.qzv

Repeating the alpha / beta diversity 'core metrics' analysis to follow individual dogs through treatment time course

    qiime diversity core-metrics-phylogenetic \
        --i-phylogeny EnticeAmplicons-rooted-tree.qza \
        --i-table amplicons-table-dada2.qza \
        --p-sampling-depth 13286 \
        --m-metadata-file ENTiCEampliconsub2Metadata.tsv \
        --output-dir Enticeamplicons-sub2-core-metrics-results \
        ;
Qiime executed with mesg:

Saved FeatureTable[Frequency] to: Enticeamplicons-sub2-core-metrics-results/rarefied_table.qza
Saved SampleData[AlphaDiversity] % Properties('phylogenetic') to: Enticeamplicons-sub2-core-metrics-results/faith_pd_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-sub2-core-metrics-results/observed_otus_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-sub2-core-metrics-results/shannon_vector.qza
Saved SampleData[AlphaDiversity] to: Enticeamplicons-sub2-core-metrics-results/evenness_vector.qza
Saved DistanceMatrix % Properties('phylogenetic') to: Enticeamplicons-sub2-core-metrics-results/unweighted_unifrac_distance_matrix.qza
Saved DistanceMatrix % Properties('phylogenetic') to: Enticeamplicons-sub2-core-metrics-results/weighted_unifrac_distance_matrix.qza
Saved DistanceMatrix to: Enticeamplicons-sub2-core-metrics-results/jaccard_distance_matrix.qza
Saved DistanceMatrix to: Enticeamplicons-sub2-core-metrics-results/bray_curtis_distance_matrix.qza
Saved PCoAResults to: Enticeamplicons-sub2-core-metrics-results/unweighted_unifrac_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-sub2-core-metrics-results/weighted_unifrac_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-sub2-core-metrics-results/jaccard_pcoa_results.qza
Saved PCoAResults to: Enticeamplicons-sub2-core-metrics-results/bray_curtis_pcoa_results.qza
Saved Visualization to: Enticeamplicons-sub2-core-metrics-results/unweighted_unifrac_emperor.qzv
Saved Visualization to: Enticeamplicons-sub2-core-metrics-results/weighted_unifrac_emperor.qzv
Saved Visualization to: Enticeamplicons-sub2-core-metrics-results/jaccard_emperor.qzv
Saved Visualization to: Enticeamplicons-sub2-core-metrics-results/bray_curtis_emperor.qzv

Repeating the alpha / beta diversity 'core metrics' analysis to follow days of treatment along with individual dogs through treatment time course
